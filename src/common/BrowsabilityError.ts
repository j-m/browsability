export class BrowsabilityError {
  ...
  static readonly MISSING_FILE = (...error: string[]): BrowsabilityError =>
  ...
  static readonly READ_FAILED = (...error: string[]): BrowsabilityError =>
    new BrowsabilityError(
      'READ_FAILED',
      'Could not read file',
  ...
  static readonly PARSE_FAILED = (...error: string[]): BrowsabilityError =>
    new BrowsabilityError(
      'PARSE_FAILED',
